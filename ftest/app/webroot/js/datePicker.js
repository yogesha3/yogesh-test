	...
	var $doc = $(document),
        ...
        Template = $('<div class="rangePicker"> \
        				<div class="wrap"> \
							...
							<div class="custom"> \
								...
								<footer> \
									<button type="button" class="btn btn-sm back_btn text-center add_focus confirm">Apply</button> \
									<button type="button" class="btn btn-sm back_btn text-center add_focus cancel">Cancel</button> \
								</footer> \
							</div> \
						</div> \
					</div>');
		...
		RangePicker.prototype = {
			...
			show : function(){
				...
				//Hide picker on window scroll
				//$(window).scroll(function(){alert(that.attr('class')); });
