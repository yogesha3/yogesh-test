                    ...
                    <div class="city_name"><?php echo $group['Group']['stateName'];?> <br>
                      ...
                      <div class="rating_icon"> 
                        ...
                        <?php $groupId = $group['Group']['id']; ?>
                         <a class="pic-caption bottom-to-top" href="javascript:void(0)" data-toggle="modal" data-target="#myModal" onclick="popUp('<?php echo $actionUrl;?>', '<?php echo $groupId; ?>','<?php echo 'groups'; ?>', '<?php echo 'updateGroup'; ?>', '<?php echo $this->Session->read('UID'); ?>')" escape = false>
