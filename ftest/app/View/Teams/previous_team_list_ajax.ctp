...
<?php echo $this->Paginator->options(array('url' => array('action'=>'previousTeamList',"perpage"=>$perpage,"search"=>$search,'sort'=> $this->Session->read('sort'),'direction'=> $this->Session->read('direction'))));
?>
