...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="page-header">
            <?php echo $this->Html->tag('h1', 'About Us');?>
        </div>
    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php
                echo $this->Form->create('pages', array('url' => array('controller' => 'cms', 'action' => 'about', 'admin'=>true), 'class' => 'smart-wizard form-horizontal', 'id' => 'editAboutUsForm'));
                ...
                <div id="wizard" class="swMain">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <?php  
                            echo $this->Form->textarea('Page.page_content', array('rows' => 5, 'label' => false, 'class' => 'form-control', 'id' => 'page_content', 'placeholder' => 'Page Content','style'=>"resize: none")); ?>
                        </div>
                    </div>
