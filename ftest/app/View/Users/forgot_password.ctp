		...
		<div class="row">
			<div class="col-sm-12 ">
				<div class="become_head">
					...
					<div class="clearfix"></div>
					<p class="forgot_informative">Enter your email address to reset your password. You may need to check your spam folder or unblock <a href="mailto:no-reply@foxhopr.com">no-reply@foxhopr.com</a></p>
				</div>
			</div>
		</div>
		<div class="row"></div>
